...
First, thank you for your interest in contributing to mkdocs-editor-notes! Even though this is mostly a personal project,
it takes a bit of work to keep it maintained. All contributions help and improve it.


## Contact Us

The maintainers of mkdocs-editor-notes can be reached most easily via email:
...
However, to establish a baseline of acceptable conduct, the mkdocs-editor-notes project expects contributors to adhere to
...
> [!Note]
> The maintainers of mkdocs-editor-notes _hate_ the use of `!` to indicate breaking changes in the subject line. If you
...
The mkdocs-editor-notes project uses [mkdocs-material](https://squidfunk.github.io/mkdocs-material/) for document
generation.
...
> [!Note]
> The maintainers of mkdocs-editor-notes don't like starting the docstring on the same line as the triple-quotes.
